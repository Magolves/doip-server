...
**doip-server** is a C++17 library implementing **Diagnostics over IP (DoIP)** protocol (server part) according to ISO 13400-2:2019. See also [Acknowledgements](../README.md#acknowledgments).


### High-Level Information
- **Language**: C++17 (required, no extensions)
- **Build System**: CMake 3.15+ with Make generator preferred
...
- **DoIP Client**: Diagnostic client implementation (still widely original code from libdoip) - not maintained. Kept for testing purposes only.
...
sudo apt-get update
sudo apt-get install -y cmake gcc-11 g++-11 libspdlog-dev livcli11-dev
