...
/** @brief Negative response indicator byte (first byte of a negative response) */
const uint8_t UDS_NEGATIVE_RESPONSE_INDICATOR = 0x7F;

/**
 * @brief  Check if the given response is a negative UDS response
 *
 * @param response the UDS response ByteArray
