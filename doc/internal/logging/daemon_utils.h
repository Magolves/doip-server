/**
 * @file daemon_utils.h
 * @brief Unix daemon utilities for process daemonization
 * 
 * This file provides utilities for proper Unix daemon creation following
 * the standard double-fork technique and best practices.
 */
